        ...
        <table id="datosb" class="table table-md display responsive nowrap" style="width:100%">
            ...
            <tbody>
                ...
                while ($filaglpi = $resultadoglpi->fetch_assoc()) {
                    ...
                    $resultado = mysqli_query($con, "SELECT * FROM $tabla2 WHERE serial='$serialglpi'");
...
<a class='dropdown-item' href='../db/editar.php?Editar=" . $filaglpi['id'] . "'>Editar</a>
...
<a class='dropdown-item' href='../db/consultaymodifica.php?Subiracta=" . $fila['id'] . "&Serial=" . $fila['serial'] . "'>Subir acta</a>
</div>
...
<a class='dropdown-item' href='../db/consultaymodifica.php?Borraracta=" . $fila['id'] . "&Serial=" . $fila['serial'] . "'>Borrar acta</a>
                    ...
                    echo "
<td class='text-center'>" . $filaglpi['serial'] . "</td>
<td class='text-center'>" . $filaglpi['otherserial'] . "</td>
<td class='text-center'>" . $marcatraducida . "</td>
<td class='text-center'>" . $modelotraducido . "</td>
<td class='text-center'>" . $yeartraducido . "</td>
<td class='text-center'>" . $fila['estado'] . "</td>
<td class='text-center'>" . $fila['usuario'] . "</td>
<td class='text-center'>" . $ubicaciontraducida . "</td>
...
<td class='text-center'>" . $filaglpi['name'] . "</td>
